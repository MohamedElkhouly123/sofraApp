...
public class ClientMakeNewOrderRestaurant {
    ...
    @Expose
    private List<ClientMakeNewOrderCategory> categories = null;
    ...
    public List<ClientMakeNewOrderCategory> getCategories() {
        return categories;
    }

    public void setCategories(List<ClientMakeNewOrderCategory> categories) {
