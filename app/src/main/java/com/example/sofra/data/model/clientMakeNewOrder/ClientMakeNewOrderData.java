...
public class ClientMakeNewOrderData {
    ...
    @Expose
    private List<ClientMakeNewOrderItem> items = null;
    ...
    public List<ClientMakeNewOrderItem> getItems() {
        return items;
    }

    public void setItems(List<ClientMakeNewOrderItem> items) {
        this.items = items;
    }
