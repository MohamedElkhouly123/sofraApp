...
public class RestaurantAndClientOffersFragment extends BaSeFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_more_restaurant_offers, container, false);
